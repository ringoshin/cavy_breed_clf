...
# Compare PR curves and ROC curves between different models
Compare_Multiple_PR_Curves(y_test, y_score_dict)
Compare_Multiple_ROC_Curves(y_test, y_score_dict)
#Compare_Multiple_PR_Curves(y_test, y_score_dict, zoom_level=0.5)
#Compare_Multiple_ROC_Curves(y_test, y_score_dict, zoom_level=0.5)

# Deep dive at selected model
clf_name = 'OVR Random Forest'
y_score = y_score_dict[clf_name] 
_ = Plot_Precision_Recall_Curve(y_test, y_score, target_names, 
